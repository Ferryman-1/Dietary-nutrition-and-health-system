				...
				<div class="tm-header">
					<div class="row tm-header-inner">
						...
						<nav class="col-md-8 col-12 tm-nav">
							<ul class="tm-nav-ul">
								<li class="tm-nav-li"><a href="index1" class="tm-nav-link">首页</a></li>
								<li class="tm-nav-li"><a href="selectMenu" class="tm-nav-link  active">菜谱管理</a></li>
								<li class="tm-nav-li"><a href="suggest" class="tm-nav-link">健康建议管理</a></li>
								<li class="tm-nav-li"><a href="selectChat" class="tm-nav-link">论坛管理</a></li>
								<li class="tm-nav-li"><a href="info" class="tm-nav-link">个人信息管理</a></li>
								<li class="tm-nav-li"><a href="contact" class="tm-nav-link">联系我们</a></li>
							</ul>
						</nav>	
					</div>
				</div>
    		...
    		<table class="tables" align="center">
					...
					<c:forEach items="${requestScope.menuList}" var="menu">
						...
						<tr class="status_open" align="center">
							...
							<td><a class="asty" href="menu/word/menu_detail.jsp?htm_name=${menu.htm_name}">${menu.menu_name }</a></td>
							<td>
