...
<div class="a">
<form action="updateHealthyInfo" method="post" onsubmit="return checkForm(this);">

<input type="hidden" name="id" value="${requestScope.healthyInfo.id}"/>
<input type="hidden" name="type_id" value="${requestScope.healthyInfo.type_id}"/>
	<table  width=45%" cellpadding="0" cellspacing="0" border="1" class="gridtable">
    	<tr align="center" height="30">
    		...
    		<tr align="center" height="30">
    		<td><input type="text" name="name" value="${healthyInfo.name }" class="input3"/></td>
    		<td><input type="text" name="value" value="${healthyInfo.value }" class="input2"/></td>
    		<td> 
