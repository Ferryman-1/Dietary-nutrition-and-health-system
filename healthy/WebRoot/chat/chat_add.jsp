...
<body> 
	...
	<!-- Top box -->
		...
		<div class="placeholder">
			<div class="parallax-window" data-parallax="scroll" data-image-src="img/simple-house-01.jpg">
					...
					<div class="row tm-header-inner">
						...
						<nav class="col-md-10 col-12 tm-nav">
							<ul class="tm-nav-ul">
								...
								<li class="tm-nav-li"><a href="selectChat" class="tm-nav-link   active">论坛管理</a></li>
				...
				<h1 class="col-12 text-center tm-section-title">写文章页面</h1>
				
			</header>
			<div class="tm-section tm-container-inner" align="center">
		
				<form action="addChat" enctype="multipart/form-data" method="post" id="form2">
	...
	<tr height="30" >
		<td width="20%" align="right">请选择图片文件：</td>
