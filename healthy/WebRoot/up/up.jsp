	...
	<!-- Top box -->
					...
					<div class="row tm-header-inner">
						...
						<nav class="col-md-10 col-12 tm-nav">
							<ul class="tm-nav-ul">
								...
								<li class="tm-nav-li1"><a href="selectUpByUserId?id=${user.id}" class="tm-nav-link active">点赞菜谱</a></li>
		...
		<main>
			<header class="row tm-welcome-section">
				<h2 class="col-12 text-center tm-section-title">点赞菜谱</h2>
				<p class="col-12 text-center">您所点赞的菜谱都收录于此</p>
				<br/>
			</header>
			<div class="row tm-gallery">
				...
				<div id="tm-gallery-page-pizza" class="tm-gallery-page">
					<c:forEach items="${requestScope.upList1}" var="up">	
					<c:forEach items="${requestScope.menuList}" var="menu">
					<c:if test="${up.menu_id==menu.id}">
					...
					<article class="col-lg-3 col-md-4 col-sm-6 col-12 tm-gallery-item">
						<figure>
							...
							<figcaption>
								...
								<a href="menu/word/menu_detail2.jsp?htm_name=${menu.htm_name}&upSum=${menu.upSum}&collectSum=${menu.collectSum}" class="tm-gallery-a">${menu.menu_name }</a>
								<a class="dza" href="deleteUpById3?id=${up.id }">取消点赞</a>
								</h4>
