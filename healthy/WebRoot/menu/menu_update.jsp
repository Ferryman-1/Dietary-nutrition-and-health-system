...
<body> 
	...
	<!-- Top box -->
		...
		<div class="placeholder">
			<div class="parallax-window" data-parallax="scroll" data-image-src="img/simple-house-01.jpg">
				...
				<h1 class="col-12 text-center tm-section-title">菜谱修改页面</h1>
				
			</header>
			<div class="tm-section tm-container-inner" align="center">
			<c:forEach items="menu">
				<form action="updateMenu" enctype="multipart/form-data" method="post" id="form2">
				<input type="hidden" name="id" value="${menu.id }"/>
			<table class="amtable1">	
			<tr height="30">
		<td width="20%" align="right">菜谱名：</td>
		<td><input type="text" name="menu_name" value="${menu.menu_name }" id="menu_name" class="input"></td>
		</tr>
		<tr height="30">
			<td width="20%" align="right">人群类型：</td>
		<td>
		<c:forEach items="${requestScope.typeList}" var="type">
		
		
			<input id="type_id" type="checkbox" value="${type.id }" name="type_id"
			<c:forEach items="${requestScope.menutypeList}" var="menutype">
				<c:if test="${menutype.type_id==type.id }">checked</c:if>
			</c:forEach>
			/>${type.type_name }
	...
	<tr height="30">
		...
		<td>
			<textarea name="show1" id="show1">${menu.show1 }</textarea>
		</td>
	</tr>
	<tr>
		<td colspan="2" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
